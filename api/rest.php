...
class Rest
{
    ...
    // statut de la réponse HTTP (code numérique à 3 chiffres)
    protected $contentType;

    // indique le format de la réponse HTTP : "application/xml; charset=utf-8" ou "application/json; charset=utf-8"
    protected $request = array();

    // tableau contenant les données envoyées avec la requête
