    ...
    //        for ($i=0; $i <= sizeof(Trace::getLesPointsDeTrace()); $i++)
        ...
        public function existeAdrMailUtilisateur($adrMail){
            ...
            if($req->fetch()){
                ...
                // si elle vaut 'true' il y a au moins une donnï¿½e sur cette ligne
                // sinon si elle vaut 'false' la ligne est vide (et il n'y en a pas d'autre derriï¿½re)
        ...
        //Mï¿½thode permettant de supprimer une Trace quelconque
        public function supprimerUneTrace($idTrace){
            ...
            //Exï¿½cution des requï¿½tes
            $reqSupprimerTrace->execute();
            $reqSupprimerPoints->execute();
            
            
            //Condition de vï¿½rification de la bien exï¿½cution des requï¿½tes
        ...
        //Mï¿½thode permettant de terminer une trace qui est en cours
