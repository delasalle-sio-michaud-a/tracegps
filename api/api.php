    ...
    { // récupère le contenu du paramètre action et supprime les "/"
        ...
        switch ($action) {
            ...
            case "creerunutilisateur":
                {
                    $this->CreerUnUtilisateur();
                    break;
                }
            case "gettouslesutilisateurs":
                {
                    $this->GetTousLesUtilisateurs();
                    break;
                }
            ...
            case "validerdemandeautorisation":
                {
                    $this->ValiderDemandeAutorisation();
                    break;
                }
            ...
            case "getlesparcoursdunutilisateur":
                {
                    $this->GetLesParcoursDunUtilisateur();
                    break;
                }
            case "getlesutilisateursquejautorise":
                {
                    $this->GetLesUtilisateursQueJautorise();
                    break;
                }
            case "getlesutilisateursquimautorisent":
                {
                    $this->GetLesUtilisateursQuiMautorisent();
                    break;
                }
            case "getunparcoursetsespoints":
                {
                    $this->GetUnParcoursEtSesPoints();
                    break;
                }
            case "retireruneautorisation":
                {
                    $this->RetirerUneAutorisation();
                    break;
                }
            case "supprimerunparcours":
                {
                    $this->SupprimerUnParcours();
                    break;
                }
            case "demanderuneautorisation":
                {
                    $this->DemanderUneAutorisation();
                    break;
                }
            case "demarrerenregistrementparcours":
                {
                    $this->DemarrerEnregistrementParcours();
                    break;
                }
            ...
            case "arreterenregistrementparcours":
                {
                    $this->ArreterEnregistrementParcours();
                    break;
                }
